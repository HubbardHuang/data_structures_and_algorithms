 ...
 */
int
SearchFirstGreaterOrEqualIteratively(const vector<int>& array, int left_index,
                                     int right_index, int target) {
 ...
 */
int
SearchFirstGreaterOrEqualRecursively(const vector<int>& array, int left_index,
                                     int right_index, int target) {
    ...
    if (array[mid_index] < target) {
        return SearchFirstGreaterOrEqualRecursively(array, mid_index + 1, right_index,
                                                    target);
